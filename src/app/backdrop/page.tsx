    ...
    <div className="flex-grow flex flex-col justify-between min-h-screen bg-[#F3F4F6] text-slate-900 relative overflow-hidden select-none font-sans print:bg-white print:min-h-0 print:p-0">
      ...
      <div className="w-full max-w-5xl mx-auto px-16 sm:px-24 pt-14 sm:pt-16 flex justify-between items-center z-10">
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="h-8 sm:h-10 w-8 sm:w-10 bg-white border border-slate-350 rounded-full flex items-center justify-center p-1 shadow-sm">
            <span className="text-[6px] font-black text-red-700 leading-none text-center">BATURETNO</span>
          </div>
        </div>

        {/* Right: HUT RI 81 Emblem */}
        <div className="h-14 sm:h-16 w-14 sm:w-16 bg-red-600 rounded-full flex items-center justify-center text-white border-2 border-white shadow-md relative font-black text-xl sm:text-2xl">
          <span>81</span>
          <span className="absolute -bottom-1.5 bg-white text-red-600 px-1.5 py-0.5 text-[6px] font-black rounded-full uppercase border border-red-600 tracking-wider">
            HUT RI
          </span>
        </div>
      </div>
      ...
      <main className="text-center my-4 max-w-4xl mx-auto w-full px-16 sm:px-24 z-10 flex-grow flex flex-col justify-center space-y-4">
        ...
        <div className="space-y-1">
          <h1 
            className="text-4xl sm:text-6xl font-extrabold text-red-650 tracking-tight leading-none filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.15)] uppercase"
        ...
        <div className="bg-red-600/5 border-y border-red-500/10 py-2 max-w-lg mx-auto w-full rounded-lg">
          <p className="text-xs sm:text-sm font-bold text-red-700 italic">
        ...
        <div className="bg-white/80 border border-slate-200/80 rounded-2xl p-4 sm:p-5 mt-4 space-y-4 shadow-sm max-w-3xl mx-auto w-full">
          ...
          <div className="space-y-3">
            ...
            {silverAndDonors.length > 0 && (
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                <span className="text-[9px] font-black uppercase text-red-600 bg-red-50 border border-red-200 px-2 py-0.5 rounded shrink-0">Donatur & Silver</span>
      ...
      <div className="w-full relative z-10 flex flex-col pointer-events-none mt-2">
        ...
        <div className="h-6 bg-red-600 relative overflow-hidden border-t border-white flex flex-col justify-between">
