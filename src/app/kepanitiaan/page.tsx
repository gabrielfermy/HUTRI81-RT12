...
const seedSeksi = [
  ...
  { nama: 'Ketua Panitia', deskripsi: 'Penanggung jawab utama seluruh operasional', mempunyai_sub_koordinator: false, kategori: 'Inti', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,logs,proposal,backdrop' },
  { nama: 'Sekretaris', deskripsi: 'Mengelola administrasi dan notulen rapat', mempunyai_sub_koordinator: false, kategori: 'Inti', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,logs,proposal,backdrop' },
  { nama: 'Bendahara', deskripsi: 'Mengelola keluar-masuk keuangan dan iuran', mempunyai_sub_koordinator: false, kategori: 'Inti', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,logs,proposal,backdrop' },
  { nama: 'Koordinator Acara', deskripsi: 'Mengatur jalannya acara utama dan berbagai lomba', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Sub Koordinator Acara', deskripsi: 'Membantu koordinasi per sesi lomba', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Acara', deskripsi: 'Pelaksana lapangan seksi acara', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Koordinator Perlengkapan & Dekorasi', deskripsi: 'Menyediakan dan menata kebutuhan alat/dekorasi fisik', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Perlengkapan & Dekorasi', deskripsi: 'Membantu penyediaan dekorasi fisik panggung', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Koordinator Konsumsi', deskripsi: 'Mengelola ketersediaan makanan & prasmanan warga', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Konsumsi', deskripsi: 'Pelaksana konsumsi konsumsi di lapangan', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Koordinator Keamanan & Kebersihan', deskripsi: 'Menjaga ketertiban lingkungan dan kebersihan lokasi', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Keamanan & Kebersihan', deskripsi: 'Pelaksana ketertiban dan kebersihan', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Koordinator Dokumentasi', deskripsi: 'Mengambil dokumentasi video & foto acara', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Dokumentasi', deskripsi: 'Membantu perekaman dokumentasi di lapangan', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Koordinator Humas & Dana', deskripsi: 'Menghubungi sponsor luar dan menyebarkan info warga', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: true, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' },
  { nama: 'Anggota Humas & Dana', deskripsi: 'Membantu penyebaran undangan dan cari dana', mempunyai_sub_koordinator: false, kategori: 'Seksi', is_unique: false, akses_menu: 'dashboard,rundown,warga,keuangan,panitia,catatan,proposal,backdrop' }
];
