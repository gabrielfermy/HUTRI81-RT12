    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-slate-100 border border-slate-200 rounded-2xl w-full max-w-md p-6 space-y-6 relative">
        ...
        <div className="space-y-1">
          <h3 className="text-base font-bold text-slate-900">Tambah Kepala Keluarga Baru</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide">Target Nominal Iuran (Rp)</label>
              <input
                type="number"
                required
                value={nominal}
